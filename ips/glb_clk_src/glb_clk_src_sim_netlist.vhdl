...
entity glb_clk_src is
  ...
  attribute NotValidForBitStream of glb_clk_src : entity is true;
end glb_clk_src;

architecture STRUCTURE of glb_clk_src is
begin
inst: entity work.glb_clk_src_glb_clk_src_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
