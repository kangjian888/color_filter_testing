...
-- Date        : Mon Jul 22 18:25:14 2019
-- Host        : DESKTOP-B3RT09T running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ glb_clk_src_sim_netlist.vhdl
-- Design      : glb_clk_src
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_glb_clk_src_clk_wiz is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_glb_clk_src_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_glb_clk_src_clk_wiz is
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_glb_clk_src,
      O => clkfbout_buf_glb_clk_src
    );
...
plle2_adv_inst: unisim.vcomponents.PLLE2_ADV
    generic map(
      ...
      STARTUP_WAIT => "FALSE"
        ...
        port map (
      CLKFBIN => clkfbout_buf_glb_clk_src,
      CLKFBOUT => clkfbout_glb_clk_src,
      CLKIN1 => clk_in1_glb_clk_src,
      CLKIN2 => '0',
      CLKINSEL => '1',
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_glb_clk_src_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
