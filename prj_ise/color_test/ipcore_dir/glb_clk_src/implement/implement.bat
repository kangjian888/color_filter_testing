...
xst -ifn xst.scr
move glb_clk_src_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\glb_clk_src_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc glb_clk_src_exdes.ucf glb_clk_src_exdes

echo 'Running map'
map -timing -pr b glb_clk_src_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm glb_clk_src_exdes -w routed.ncd routed.v
cd ..
